...
# set_location_assignment PIN_7 -to rxd0
# set_location_assignment PIN_12 -to txd0
...
# set_location_assignment PIN_60 -to bk_din[1]
...
# set_location_assignment PIN_59 -to bk_din[5]
